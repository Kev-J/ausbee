...
# Add source files
ifeq ($(CONFIG_LIBAUSBEE_INIT),y)
LIBAUSBEE_SRC_FILES+=$(LIBAUSBEE_SRC_PATH)/initialisation/clkInit.c
LIBAUSBEE_SRC_FILES+=$(LIBAUSBEE_SRC_PATH)/initialisation/gpioInit.c
endif
ifeq ($(CONFIG_LIBAUSBEE_LED),y)
LIBAUSBEE_SRC_FILES+=$(LIBAUSBEE_SRC_PATH)/led/led.c
endif
