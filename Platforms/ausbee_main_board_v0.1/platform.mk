...
PLATFORM_DEP_FILES=$(patsubst ${AUSBEE_DIR}/%.d,${OUTPUT_PATH}/%.o,${PLATFORM_SRC_FILES})
...
$(PLATFORM_DEP_FILES): $(OUTPUT_PATH)/%.d :$(AUSBEE_DIR)/%.c $(TOOLCHAIN_EXTRACTED) $(CONFIG_DEPS)
	@mkdir -p $(dir $@)
	$(HOST_CC) $(HOST_CFLAGS) $(STM32F4XX_STDPERIPH_DRIVER_INCLUDES) $(SYSTEM_INCLUDES) $(HOST_OPTIMISATION) -MF"$@" -MG -MM -MP -MT"$@" -MT"${OUTPUT_PATH}/$(<:.c=.o)" "$<"
