...
PLATFORM_SRC_FILES+=$(wildcard $(PLATFORM_STM32F7DISCOVERY)/*.c)
...
$(PLATFORM_OBJ_FILES): $(OUTPUT_PATH)/%.o :$(AUSBEE_DIR)/%.c $(TOOLCHAIN_EXTRACTED) $(CONFIG_DEPS)
	...
	$(HOST_CC) -o $@ $(HOST_CFLAGS) $(STM32F7XX_HAL_DRIVER_INCLUDES) $(PLATFORM_INCLUDES) $(SYSTEM_INCLUDES) $(HOST_OPTIMISATION) -c $<
