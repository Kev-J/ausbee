...
AUSBEE_CUSTOM_PLATFORMS_OPTION_KCONFIG_PATH=$(AUSBEE_DIR)/Platforms/empty.Kconfig
...
AUSBEE_CUSTOM_PLATFORMS_OPTION_KCONFIG_PATH=$(CONFIG_CUSTOM_PLATFORMS_PATH)/option.Kconfig
endif
AUSBEE_CUSTOM_PLATFORMS_PATH=$(CONFIG_CUSTOM_PLATFORMS_PATH)
endif

#export custom platforms Kconfig path
export AUSBEE_CUSTOM_PLATFORMS_KCONFIG_PATH
export AUSBEE_CUSTOM_PLATFORMS_OPTION_KCONFIG_PATH

#export custom platforms Kconfig path
export AUSBEE_CUSTOM_PLATFORMS_PATH
