...
AUSBEE_CUSTOM_PLATFORMS_KCONFIG_CHOICE_PATH=$(AUSBEE_DIR)/Platforms/empty.Kconfig
AUSBEE_CUSTOM_PLATFORMS_KCONFIG_VALUES_PATH=$(AUSBEE_DIR)/Platforms/empty.Kconfig
...
ifneq ("$(wildcard $(CONFIG_CUSTOM_PLATFORMS_PATH)/choice.Kconfig)", "")
AUSBEE_CUSTOM_PLATFORMS_KCONFIG_CHOICE_PATH=$(CONFIG_CUSTOM_PLATFORMS_PATH)/choice.Kconfig
endif
ifneq ("$(wildcard $(CONFIG_CUSTOM_PLATFORMS_PATH)/values.Kconfig)", "")
AUSBEE_CUSTOM_PLATFORMS_KCONFIG_VALUES_PATH=$(CONFIG_CUSTOM_PLATFORMS_PATH)/values.Kconfig
endif
endif

#export custom platforms Kconfig path
export AUSBEE_CUSTOM_PLATFORMS_KCONFIG_CHOICE_PATH
export AUSBEE_CUSTOM_PLATFORMS_KCONFIG_VALUES_PATH
