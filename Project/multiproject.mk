...
$(PROJECT_DEP_FILES): ${PROJECT_OUTPUT_PATH}/%.d: %.c $(PACKAGES_EXTRACTED) $(TOOLCHAIN_EXTRACTED) $(CONFIG_DEPS)
	@mkdir -p $(dir $@)
	$(HOST_CC) $(HOST_CFLAGS) $(PROJECT_INCLUDES) $(HOST_OPTIMISATION) -MF"$@" -MG -MM -MP -MT"$@" -MT"${PROJECT_OUTPUT_PATH}/$(<:.c=.o)" "$<"
