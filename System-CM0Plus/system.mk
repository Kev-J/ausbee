...
CMSIS_DEVICE_SUPPORT_PATH=$(CMSIS_PATH)/Device/ST/STM32L0xx

LINKER_SCRIPT=$(OUTPUT_PATH)/link.ld
LINKER_SCRIPT_INPUT=$(SYSTEM_PATH)/link.ld.in

SYSTEM_INCLUDES=-I"$(CMSIS_PATH)/Include"
...
SYSTEM_SRC_C_FILES+=$(CMSIS_DEVICE_SUPPORT_PATH)/Source/Templates/system_stm32l0xx.c
#SYSTEM_SRC_C_FILES+=$(SYSTEM_PATH)/syscalls.c

SYSTEM_SRC_S_FILES+=$(CMSIS_DEVICE_SUPPORT_PATH)/Source/Templates/gcc/startup_$(shell echo $(DEVICE_NAME) | tr A-Z a-z).s
