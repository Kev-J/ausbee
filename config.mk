...
OUTPUT_TARGET_SIM=$(subst $(DQUOTE),,$(OUTPUT_PATH)/$(CONFIG_PROJECT_NAME).sim)
...
GLOBAL_CFLAGS+=-DHSE_VALUE=$(CRYSTAL_FREQUENCY)
GLOBAL_CXXFLAGS+=-DHSE_VALUE=$(CRYSTAL_FREQUENCY)
