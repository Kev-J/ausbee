...
GLOBAL_COMMON_FLAGS=-DPROJECT_NAME=\"$(PROJECT_NAME)\"
TARGET_COMMON_FLAGS=-DAUSBEE_TARGET -std=gnu99
SIM_COMMON_FLAGS=-DAUSBEE_SIM -std=gnu99 -m32
...
# CFLAGS and CXXFLAGS
TARGET_CFLAGS=$(GLOBAL_COMMON_FLAGS) $(TARGET_COMMON_FLAGS) $(subst $(DQUOTE),,$(CONFIG_TARGET_TOOLCHAIN_CFLAGS))
TARGET_CXXFLAGS=$(GLOBAL_COMMON_FLAGS) $(TARGET_COMMON_FLAGS) $(subst $(DQUOTE),,$(CONFIG_TARGET_TOOLCHAIN_CXXFLAGS) )
SIM_CFLAGS=$(GLOBAL_COMMON_FLAGS) $(SIM_COMMON_FLAGS) $(subst $(DQUOTE),,$(CONFIG_SIM_TOOLCHAIN_CFLAGS))
SIM_CXXFLAGS=$(GLOBAL_COMMON_FLAGS) $(SIM_COMMON_FLAGS) $(subst $(DQUOTE),,$(CONFIG_SIM_TOOLCHAIN_CXXFLAGS) )
