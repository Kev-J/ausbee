...
else ifeq ($(CONFIG_DEVICE_STM32F042x6),y)
DEVICE_NAME=STM32F042x6
else ifeq ($(CONFIG_DEVICE_STM32L496xx),y)
DEVICE_NAME=STM32L496xx
else ifeq ($(CONFIG_DEVICE_XMEGA16A4),y)
DEVICE_NAME=XMEGA16A4
GLOBAL_CFLAGS+=-mmcu=atxmega16a4 -DF_CPU=$(CRYSTAL_FREQUENCY)
TARGET_LDFLAGS+=-mmcu=atxmega16a4
endif
