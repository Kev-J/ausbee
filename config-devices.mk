...
else ifeq ($(CONFIG_DEVICE_ATMEGA328P),y)
DEVICE_NAME=ATMEGA328P
HOST_COMMON_FLAGS+=-mmcu=atmega328p
AVRDUDE_PART=m328p
else ifeq ($(CONFIG_DEVICE_ATXMEGA128A1),y)
DEVICE_NAME=ATXMEGA128A1
HOST_COMMON_FLAGS+=-mmcu=atxmega128a1
AVRDUDE_PART=x128a1
endif
